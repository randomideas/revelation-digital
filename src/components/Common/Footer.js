	...
	render() {
        ...
        <div className="row">
          <div className="col col--6 col--sm-12">
	        <p>&copy; {(new Date().getFullYear())} Revelation Digital Media | All rights reserved<br />A <a href="http://www.statusproductions.com.au" target="_blank"  rel="noreferrer noopener">Status Productions Pty Ltd</a> Company</p>
