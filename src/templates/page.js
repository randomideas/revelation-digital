				...
				<> {(PageCode === "brief-us") ? (
						...
						<div className="section section--normal-margin default-page">
							<div className="container container-small">
								 <iframe height="2000" width="100%" frameBorder="0" src={"https://development.revelation.digital/gravity-page/?gid=4"} title="description" />
							...
							<div className="contact-popup-wrapper" id={"contact-popup-"+(i+1)}>
								...
								<div className="popup-container">
									...
									<h3 className="text-bebas text-bebas--big text-bebas--stroke leave-details-text">{propforms.title}</h3>
									 <iframe height="650" width="100%" frameBorder="0" src={"https://development.revelation.digital/gravity-page/?gid="+propforms.form} title="description" /> 
